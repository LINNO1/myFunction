...
/*------------------路由配置--------------------------------*/
var routes = {
  '/loadNews': function(staticPath,req,res){
                readFile(path.join(staticPath,'src','loadNews.json'),req,res);
                },
  '/loadMore': function(staticPath,req,res){
                 var data=[];
   ...
   '/zhubao': function(staticPath,req,res){
              readFile(path.join(staticPath,'src','zhubao.json'),req,res);
                },

    '/fenye':function(staticPath,req,res){
              readFile(path.join(staticPath,'src','loadNews.json'),req,res);
                },
          ...
          default: //readFile(path.join(staticPath,'loadMore.html'),req,res);
                 // readFile(path.join(staticPath,'zhubao.html'),req,res);
                  // readFile(path.join(staticPath,'loadMorejq.html'),req,res);
                   readFile(path.join(staticPath,'fenye.html'),req,res);
